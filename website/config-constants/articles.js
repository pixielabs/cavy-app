function articles(baseUrl) {
  return [
    {
      content:
        "Send Cavy test results to iOS or Android test runners, or write your own report handler.",
      title: "Cavy — better test reporting for React Native integration tests",
    ...
    {
      content:
        "Cavy is an open-source end-to-end integration test framework for React Native, developed for use with both iOS and Android applications. ",
      title: "Announcing Cavy",
      author: 'Abigail McPhillips',
      image: baseUrl + "img/cavy.png",
      link:
